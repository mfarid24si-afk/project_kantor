/* =====================================================================
 * IKON SVG (gaya Lucide, stroke-based) — pengganti emoji
 * Dipakai lewat helper icon(name). Ukuran ikon diatur per konteks
 * melalui CSS (.ic) di style.css, warna mengikuti currentColor.
 * ===================================================================== */
...
/** Kembalikan markup SVG untuk sebuah ikon (dekoratif, aria-hidden). */
